...
class MakeShrinkMap():
    ...
    def __call__(self, data: dict) -> dict:
        ...
        data['shrink_map'] = torch.tensor(gt)#gt
        data['shrink_mask'] = torch.tensor(mask)#mask
        return data
...
class MakeBorderMap():
    ...
    def __call__(self, data: dict) -> dict:
        ...
        data['threshold_map'] = torch.tensor(canvas)#canvas
        data['threshold_mask'] = torch.tensor(mask)#mask
        return data
